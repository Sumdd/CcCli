...
namespace CenoQnviccub
{
	public class BriSDKLib
	{
		...
		//2010/09/20
		//public const int QNV_DLL_VER =0x105;
		//public const string QNV_DLL_VER_STR = "1.05";

		//2010/10/29
		//public const int QNV_DLL_VER =0x106;
		//public const string QNV_DLL_VER_STR = "1.06";
		...
		public const int ODT_AUDRV = 0x20; //虚拟声卡模块
		//
		...
		//虚拟声卡
		//uAudioType
		public const int QNV_AUDRV_INSTALL = 1;
		public const int QNV_AUDRV_UNINSTALL = 2;
		public const int QNV_AUDRV_ISINSTALL = 3;
		public const int QNV_AUDRV_SETWAVEOUTID = 4;
		public const int QNV_AUDRV_SETWAVEINID = 5;
		public const int QNV_AUDRV_SWITCHWAVEOUTID = 6;
		public const int QNV_AUDRV_SWITCHWAVEINID = 7;
		public const int QNV_AUDRV_WAVEOUTCOUNT = 8;
		public const int QNV_AUDRV_WAVEINCOUNT = 9;
		...
		public const int BRI_EVENT_MESSAGE = (int)Win32API.WinMsg.WM_USER + 2000;//事件消息
		public const int BRI_RECBUF_MESSAGE = (int)Win32API.WinMsg.WM_USER + 2001;//缓冲录音数据消息
		...
		public const int QNV_PARAM_CITYCODE = 60;//设置本地城市区号
		...
		//虚拟声卡
		[DllImport("qnviccub.dll")]
		public static extern Int32 QNV_Audrv(UInt32 uAudioType, Int32 nValue, string pInValue, string pOutValue, Int32 lBufSize);
	}
}
