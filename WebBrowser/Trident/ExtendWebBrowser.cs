...
namespace WebBrowser
{
	...
	{
		public string currentPhone = string.Empty;
		public string currentRecord = string.Empty;
		...
		protected override void WndProc(ref Message m)
		{
			...
			catch (Exception ex)
			{
				...
				LogFile.Write(typeof(ExtendedWebBrowser), LOGLEVEL.ERROR, "intiliate webbrowser error", ex);
			}
		}
